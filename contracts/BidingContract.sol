...
contract Marketplace  {
    ...
    struct Auction {
        ...
        address addressNFT; // Address of the ERC721 NFT Collection contract
    ...
    //  * @param _addressNFT address of the ERC721 NFT collection contract
    ...
    function createAuction(
        ...
        // Get NFT collection contract
         IERC721 ierc721 = IERC721(_addressNFT);
        
        //nftToken ierc721 = nftToken(_addressNFT);

        // Make sure the sender that wants to create a new auction
        // for a specific NFT is the owner of this NFT
        require(
            ierc721.ownerOf(_nftId) == msg.sender,
        ...
        require(
            ierc721.getApproved(_nftId) == address(this),
            "Require NFT ownership transfer approval"
        );

        // Lock NFT in Marketplace contract
      //  require(ierc721.transferFrom(msg.sender, address(this), 0));
    ...
    function claimNFT(uint256 _auctionIndex) external {
        ...
        // Get NFT collection contract
        IERC721 ierc721 = IERC721(auction.addressNFT);

        // Transfer NFT from marketplace contract
        // to the winner address
        
            ierc721.transferFrom(address(this),auction.currentBidOwner,_auctionIndex);
